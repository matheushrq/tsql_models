...
select	convert(smalldatetime, format(@data_exp, 'yyyyMM' + RIGHT(convert(varchar(8), day(getdate()), 103), 2)))
select	convert(smalldatetime, format(@data_exp, 'yyyyMM' + RIGHT('0' + convert(varchar(10), @d), 2)))
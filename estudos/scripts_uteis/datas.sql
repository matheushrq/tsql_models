...
select	convert(smalldatetime, FORMAT(DATEADD(month, 0, GETDATE()), 'yyyyMM' + '10')) -- n�o altera o m�s e muda o dia para 10
...
-- Adiciona uma coluna de aniversário baseado em ano atual
...
-- alterando a data de nascimento para um ano antes do cadastrado, mantendo o dia e mês
UPDATE	p
